...
vignette were hired as full-time developers at ICES. In 2017, the first version
of the `icesTAF` package was released on CRAN, followed by a steady rate of
version updates. In 2021-2022, the package was split into two separate but
related packages:
...
vignette (Magnusson 2023) contains annotated examples and a discussion.
