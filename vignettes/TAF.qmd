...
When authoring a TAF analysis, one can either start from a similar workflow
...
combination with the `renv` package (Ushey and Wickham 2025), Docker (Merkel
2014), or other tools dedicated to reproducible research.
