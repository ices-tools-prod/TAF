...
Alternatively, TAF can be used in combination with the `renv` package, `rig`
(Csárdi 2024), Docker (Merkel 2014), and other tools dedicated to reproducible
research.
...
The simple and general design of TAF, independent from specific technologies,
has proven both stable and easy to adapt to a continually evolving ecosystem of
available software.
